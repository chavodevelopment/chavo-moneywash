...
QBCore.Functions.CreateCallback("chavo-MoneyWash:isWashing", function(source, cb, washerId)
    cb(washers[washerId].washing)
end)


QBCore.Functions.CreateCallback("chavo-MoneyWash:isReady", function(source, cb, washerId)
    cb(washers[washerId].pickup)
end)


RegisterServerEvent("chavo-MoneyWash:startwasher", function(data)
    local src = source
...
RegisterServerEvent("chavo-MoneyWash:collect", function(data)
    src = source
